...
def test_recovery_state_aligns_with_schema() -> None:
    ...
    assert "external_feedback_cursor" in RECOVERY_CHECKPOINTS
    assert "publication_pre_commit" in RECOVERY_CHECKPOINTS
    ...
    assert "external_feedback_cursor_not_started" in RECOVERY_REASON_CODES
    assert "publication_pre_commit_interrupted" in RECOVERY_REASON_CODES
