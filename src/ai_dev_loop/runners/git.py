...
def _validate_package_private_ref(ref: str) -> None:
    if ref.startswith("refs/ai-dev-loop/recovery/") or ref.startswith("refs/ai-dev-loop/rollover/"):
        return
    raise ValidationError("package private ref must use recovery or rollover namespace")
...
def recovery_git_private_ref_peek(
    ...
    *,
    ...
    _validate_package_private_ref(ref)
    result = run_process(
