...
ROLLOVER_WORKTREES_DIRNAME = "rollover-worktrees"
...
def rollover_worktree_root(state_root: Path, rollover_id: str) -> Path:
    return state_root / ROLLOVER_WORKTREES_DIRNAME / safe_run_directory_key(rollover_id)
